...
public class FootIK : MonoBehaviour
{
    ...
    private void OnAnimatorIK(int layerIndex)
    {
        ...
        if (useProIkFeature)
        {
            _animator.SetIKRotationWeight(AvatarIKGoal.RightFoot, 1f);//AvatarIKGoal.RightFoot,_animator.GetFloat(rightFootAnimVariableName)
        }
        ...
        if (useProIkFeature)
        {
            _animator.SetIKRotationWeight(AvatarIKGoal.LeftFoot,1f);//_animator.GetFloat(leftFootAnimVariableName)
        }
