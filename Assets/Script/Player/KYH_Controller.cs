...
{
    public Animator fullBodyAnim, armAnim;
    KYH_input input;
    KYH_Mover mover;
    ...
    private Vector3 CalculateMovementDirection()
    {
        ...
        fullBodyAnim.SetFloat("Forward", forward); fullBodyAnim.SetFloat("Side", side);
        armAnim.SetFloat("Forward", forward); armAnim.SetFloat("Side", side);
    ...
    void UpdateCrouch()
    {
        fullBodyAnim.SetBool("Crouch", !fullBodyAnim.GetBool("Crouch"));
        //mover.InitCapsuleCollider();
    }
}
