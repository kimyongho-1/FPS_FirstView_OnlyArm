...
namespace CBG.FPSMeshTool {
    ...
    public class FPSMeshToolWindow : EditorWindow {
            ...
            if (validObject && validRenderers) {
                ...
                if (validRootBone) {
                    if (validAnimator) {
                        ...
                        leftArmBone = anim.GetBoneTransform(HumanBodyBones.LeftUpperArm);
                        rightArmBone = anim.GetBoneTransform(HumanBodyBones.RightUpperArm);
                        leftLegBone = anim.GetBoneTransform(HumanBodyBones.LeftUpperLeg);
                        rightLegBone = anim.GetBoneTransform(HumanBodyBones.RightUpperLeg);
                    } else {
        ...
        void BuildFPSMesh() {
            ...
            // Create prefab
            PrefabUtility.SaveAsPrefabAssetAndConnect(previewInstance, GetValidAssetName(GeneratePrefabFileName(previewInstance)), InteractionMode.UserAction);
